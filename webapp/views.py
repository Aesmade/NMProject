...
def show(request):
    ...
    wifires = list(wifires.values("ssid", "bssid", "realpos__latitude", "realpos__longitude",
                                  ).annotate(RSSI=Avg("level"), freq=Avg("frequency"), ts=Min("timestamp")))
    ...
    ctx = {"wifi": wifires, "gps": gpsres, "bss": bssres, "data": data}
